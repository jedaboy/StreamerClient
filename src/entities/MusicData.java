...
public class MusicData implements Serializable {
    ...
    public MusicData(ImageIcon image,  Timer playTimerr, long frameCount, double duration, AudioFormat format, Clip clip, boolean playingg) throws SQLException, LineUnavailableException, IOException, UnsupportedAudioFileException {
